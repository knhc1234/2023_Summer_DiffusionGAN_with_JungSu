...
def training_loop(
    ...
    if rank == 0:
        ...
        print(training_set.label_dim, training_set.resolution, training_set.num_channels)
        print()
    ...
    while True:
        ...
        #print(cur_nimg, total_kimg, tick_start_nimg, kimg_per_tick)
        ...
        #print(cur_tick, tick_start_nimg, maintenance_time)
        #print(done)
        if done:
            break
    #print('end')
